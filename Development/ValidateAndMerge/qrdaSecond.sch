...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron"
  ...
  <sch:pattern id="p-CMS-QRDA-III-templateId-errors">
      <sch:rule id="r-CMS-QRDA-III-templateId-errors" context="cda:ClinicalDocument">
         <sch:assert id="a-CMS_QRDA-Category-III-Report-error"
                     test="count(cda:templateId[@root='2.16.840.1.113883.10.20.27.1.1'])=1">This document SHALL contain exactly one QRDA-Category-III-Report templateId (@root='2.16.840.1.113883.10.20.27.1.1') with appropriate @extension (version) of the form 'yyyy-mm-dd'.)</sch:assert>
         <sch:assert id="a-CMS_QRDA-Category-III-Report-CMS-error"
                     test="count(cda:templateId[@root='2.16.840.1.113883.10.20.27.1.2'])=1">This document SHALL contain exactly one QRDA Category IIII Report - CMS templateId (@root='2.16.840.1.113883.10.20.27.1.2') with appropriate @extension (version) of the form 'yyyy-mm-dd'.</sch:assert>
      </sch:rule>
  </sch:pattern>
  <sch:pattern id="Improvement_Activity_Performed_Measure_Reference_and_Results-template-pattern-errors">
    
      <sch:rule id="Improvement_Activity_Performed_Reference_and_Result-template-errors"
  ...
  <sch:pattern id="Improvement_Activity_Section-template-pattern-errors">
      <sch:rule id="Improvement_Activity-template-errors"
                context="cda:section[cda:templateId[@root='2.16.840.1.113883.10.20.27.2.4'][@extension='2017-06-01']]">
         <sch:assert id="a-3377-711342-error"
                     test="count(cda:templateId[@root='2.16.840.1.113883.3.249.20.2.1'][@extension='2018-05-01'])=1">SHALL contain exactly one [1..1] templateId (CONF:3377-711342) such that it SHALL contain exactly one [1..1] @root="2.16.840.1.113883.3.249.20.2.1" (CONF:CMS_70). SHALL contain exactly one [1..1] @extension="2018-05-01" (CONF:CMS_76).</sch:assert>
      </sch:rule>
  </sch:pattern>
  <sch:pattern id="Improvement_Activity_Section_CMS-pattern-errors">
      <sch:let name="intendedRecipient-IA"
               value="/cda:ClinicalDocument/cda:informationRecipient/cda:intendedRecipient/cda:id/@extension"/>
      <sch:rule id="Improvement_Activity_Section_CMS-errors"
                context="cda:section[cda:templateId[@root='2.16.840.1.113883.3.249.20.2.1'][@extension='2018-05-01']]">
      
         <sch:assert id="a-3259-21181-error"
  ...
  <sch:pattern id="Measure_data-template-pattern-errors">
      <sch:rule id="Measure_data-template-errors"
                context="cda:observation[cda:templateId[@root='2.16.840.1.113883.10.20.27.3.5'][@extension='2016-09-01']]">
         <sch:assert id="a-CMS_41-error"
                     test="count(cda:templateId[@root='2.16.840.1.113883.10.20.27.3.16'][@extension='2019-05-01'])=1">SHALL contain exactly one [1..1] templateId (CONF:CMS_41) such that it SHALL contain exactly one [1..1] @root="2.16.840.1.113883.10.20.27.3.16" (CONF:CMS_42). SHALL contain exactly one [1..1] @extension="2019-05-01" (CONF:CMS_43).</sch:assert>
      </sch:rule>
  </sch:pattern>
  <sch:pattern id="Measure_data_CMS-pattern-errors">
      <sch:rule id="Measure_data_CMS-errors"
                context="cda:observation[cda:templateId[@root='2.16.840.1.113883.10.20.27.3.16'][@extension='2019-05-01']]">
         <sch:assert id="a-4427-18141_C01-error"
         ...
         <sch:assert id="a-4427-18136_C01-error"
         ...
         <sch:assert id="a-4427-18139_C01-error"
  ...
  <sch:pattern id="Measure_Reference_and_Results-template-pattern-errors">
      <sch:rule id="Measure_Reference_and_Results-template-errors"
                context="cda:organizer[cda:templateId[@root='2.16.840.1.113883.10.20.27.3.1'][@extension='2016-09-01']]">
         <sch:assert id="a-CMS_54-error"
                     test="count(cda:templateId[@root='2.16.840.1.113883.10.20.27.3.17'][@extension='2019-05-01'])=1">SHALL contain exactly one [1..1] templateId (CONF:CMS_54) such that it SHALL contain exactly one [1..1] @root="2.16.840.1.113883.10.20.27.3.17" (CONF:CMS_55). SHALL contain exactly one [1..1] @extension="2018-05-01" (CONF:CMS_56).</sch:assert>
      </sch:rule>
  </sch:pattern>
  <sch:pattern id="Measure_Reference_and_Results_CMS-pattern-errors">
      <sch:rule id="Measure_Reference_and_Results_CMS-errors"
                context="cda:organizer[cda:templateId[@root='2.16.840.1.113883.10.20.27.3.17'][@extension='2019-05-01']]">
         <sch:assert id="a-4427-18425_C01-error"
                     test="count(cda:component[count(cda:observation[cda:templateId[@root='2.16.840.1.113883.10.20.27.3.16'][@extension='2019-05-01']])=1]) &gt; 0">SHALL contain at least one [1..*] component (CONF:4427-18425_C01) such that it SHALL contain exactly one [1..1] Measure Data - CMS (V4) (identifier: urn:hl7ii:2.16.840.1.113883.10.20.27.3.16:2019-05-01) (CONF:4427-18426_C01).</sch:assert>
      </sch:rule>
  </sch:pattern>
  <sch:pattern id="Payer_Supplemental_Data_Element-template-pattern-errors">
      <sch:rule id="Payer_Supplemental_Data_Element-template-errors"
                context="cda:observation[cda:templateId[@root='2.16.840.1.113883.10.20.27.3.9'][@extension='2016-02-01']]">
         <sch:assert id="a-CMS_47-error"
  ...
  <sch:pattern id="Payer_Supplemental_Data_Element_CMS-pattern-errors">
      <sch:rule id="Payer_Supplemental_Data_Element_CMS-errors"
      ...
      <sch:rule id="Payer_Supplemental_Data_Element_CMS-value-errors"
      ...
      <sch:rule id="Payer_Supplemental_Data_Element_CMS-translation-errors"
                context="cda:observation[cda:templateId[@root = '2.16.840.1.113883.10.20.27.3.18']]/cda:value/cda:translation">
         <sch:assert id="a-CMS_53-error"
                     test="@code=document('voc.xml')/voc:systems/voc:system[@valueSetOid='2.16.840.1.113883.3.249.14.102']/voc:code/@value">This translation SHALL contain exactly one [1..1] @code, which SHALL be selected from ValueSet CMS Payer Groupings urn:oid:2.16.840.1.113883.3.249.14.102 (CONF:CMS_53).</sch:assert>
      </sch:rule>
  </sch:pattern>
  <sch:pattern id="Performance_Rate_for_Proportion_Measure-template-pattern-errors">
      <sch:rule id="Performance_Rate_for_Proportion_Measure-template-errors"
                context="cda:observation[cda:templateId[@root='2.16.840.1.113883.10.20.27.3.14'][@extension='2016-09-01']]">
         <sch:assert id="a-CMS_59-error"
                     test="count(cda:templateId[@root='2.16.840.1.113883.10.20.27.3.25'][@extension='2018-05-01'])=1">SHALL contain exactly one [1..1] templateId (CONF:CMS_59) such that it SHALL contain exactly one [1..1] @root="2.16.840.1.113883.10.20.27.3.25" (CONF:CMS_60). SHALL contain exactly one [1..1] @extension="2018-05-01" (CONF:CMS_61).</sch:assert>
      </sch:rule>
  </sch:pattern>
  <sch:pattern id="Performance_Rate_for_Proportion_Measure_CMS-pattern-errors">
      <sch:rule id="Performance_Rate_for_Proportion_Measure_CMS-errors"
      ...
      <sch:rule id="Performance_Rate_for_Proportion_Measure_CMS-value-errors"
                context="cda:observation[cda:templateId[@root = '2.16.840.1.113883.10.20.27.3.25'][@extension = '2018-05-01']]/cda:value[@xsi:type='REAL']">
         <sch:assert id="a-CMS_62-error"
                     test="not(@value) or ((@value &gt;= 0) and (@value &lt;= 1))">The value, if present, SHALL be greater than or equal to 0 and less than or equal to 1 (CONF:CMS_62).</sch:assert>
         <sch:assert id="a-CMS_63-error"
                     test="not(@value) or (string-length(substring-after(@value,'.')) &lt;= 6)">The value, if present, SHALL contain no more than 6 digits to the right of the decimal (CONF:CMS_63).</sch:assert>
      </sch:rule>
      <sch:rule id="Performance_Rate_for_Proportion_Measure_CMS-reference-errors"
  ...
  <sch:pattern id="QRDA_Category_III_Measure_Section-template-pattern-errors">
      <sch:rule id="QRDA_Category_III_Measure-template-errors"
                context="cda:section[cda:templateId[@root='2.16.840.1.113883.10.20.27.2.1'][@extension='2017-06-01']]">
         <sch:assert id="a-CMS_64-error"
                     test="count(cda:templateId[@root='2.16.840.1.113883.10.20.27.2.3'][@extension='2019-05-01'])=1">SHALL contain exactly one [1..1] templateId (CONF:CMS_64) such that it  SHALL contain exactly one [1..1] @root="2.16.840.1.113883.10.20.27.2.3" (CONF:CMS_65). SHALL contain exactly one [1..1] @extension="2019-05-01" (CONF:CMS_66).</sch:assert>
      </sch:rule>
  </sch:pattern>
  <sch:pattern id="QRDA_Category_III_Measure_Section_CMS-pattern-errors">
      <sch:let name="intendedRecipient-Measure-CMS"
               value="/cda:ClinicalDocument/cda:informationRecipient/cda:intendedRecipient/cda:id/@extension"/>
      <sch:rule id="QRDA_Category_III_Measure_Section_CMS-errors"
                context="cda:section[cda:templateId[@root='2.16.840.1.113883.10.20.27.2.3'][@extension='2019-05-01']]">
         <sch:assert id="a-4427-17906_C01-error"
  ...
  <sch:pattern id="QRDA_Category_III-template-pattern-errors">
      <sch:rule id="QRDA_Category_III_Report-template-errors"
                context="cda:ClinicalDocument[cda:templateId[@root='2.16.840.1.113883.10.20.27.1.1'][@extension='2017-06-01']]">
         <sch:assert id="a-CMS_1-error"
                     test="count(cda:templateId[@root='2.16.840.1.113883.10.20.27.1.2'][@extension='2019-05-01'])=1">SHALL contain exactly one [1..1] templateId (CONF:CMS_1) such that it SHALL contain exactly one [1..1] @root="2.16.840.1.113883.10.20.27.1.2" (CONF:CMS_2).SHALL contain exactly one [1..1] @extension="2019-05-01" (CONF:CMS_3).</sch:assert>
      </sch:rule>
  </sch:pattern>
  <sch:pattern id="QRDA_Category_III_CMS-pattern-errors">
      <sch:let name="intendedRecipient-Doc"
               value="/cda:ClinicalDocument/cda:informationRecipient/cda:intendedRecipient/cda:id/@extension"/>
      ...
      <sch:rule id="QRDA_Category_III_CMS-confidentialityCode-errors"
      ...
      <sch:rule id="QRDA_Category_III_CMS-languageCode-errors"
      ...
      <sch:rule id="QRDA_Category_III_CMS-informationRecipient-errors"
      ...
      <sch:rule id="QRDA_Category_III_CMS-informationRecipient-intendedRecipient-errors"
      ...
      <sch:rule id="QRDA_Category_III_CMS-informationRecipient-intendedRecipient-id-errors"
         ...
         <sch:assert id="a-CMS_11-error"
                     test="@extension=document('voc.xml')/voc:systems/voc:system[@valueSetOid='2.16.840.1.113883.3.249.14.101']/voc:code/@value">This id SHALL contain exactly one [1..1] @extension, which SHALL be selected from ValueSet QRDA III CMS Program Name urn:oid:2.16.840.1.113883.3.249.14.101 STATIC 2019-05-01 (CONF:CMS_11).</sch:assert>
         <sch:assert id="a-CMS_12-error"
                     test="(@extension='CPCPLUS' and ../../../cda:participant[@typeCode='LOC']) or @extension!='CPCPLUS'">If ClinicalDocument/informationRecipient/intendedRecipient/id/@extension="CPCPLUS", then ClinicalDocument/participant/@typeCode="LOC" SHALL be present (CONF:CMS_12).</sch:assert>
         <sch:assert id="a-CMS_13-error"
                     test="(@extension='CPCPLUS' and count(../../../cda:component/cda:structuredBody/cda:component/cda:section[cda:templateId[@root='2.16.840.1.113883.10.20.27.2.3'][@extension='2019-05-01']])=1) or @extension!='CPCPLUS'">If ClinicalDocument/informationRecipient/intendedRecipient/id/@extension="CPCPLUS", then QRDA Category III Measure Section – CMS (V4) SHALL be present (CONF:CMS_13).</sch:assert>
         <sch:assert id="a-CMS_14-error"
                     test="(@extension='CPCPLUS' and count(../../../cda:component/cda:structuredBody/cda:component/cda:section/cda:entry/cda:organizer/cda:component/cda:observation[cda:templateId[@root='2.16.840.1.113883.10.20.27.3.25'][@extension='2018-05-01']]) &gt; 0) or @extension!='CPCPLUS'">If ClinicalDocument/informationRecipient/intendedRecipient/id/@extension="CPCPLUS", then Performance Rate for Proportion Measure – CMS (V3) SHALL be present (CONF:CMS_14).</sch:assert>
         <sch:assert id="a-CMS_92-error"
                     test="(@extension='CPCPLUS' and count(/cda:ClinicalDocument[cda:templateId[@root='2.16.840.1.113883.10.20.27.1.2'][@extension='2019-05-01']]/cda:participant[@typeCode='DEV']/cda:associatedEntity/cda:id[@root='2.16.840.1.113883.3.2074.1'][@extension]) &gt; 0) or @extension!='CPCPLUS'">If ClinicalDocument/informationRecipient/intendedRecipient/id/@extension="CPCPLUS", then CMS Certification ID SHALL be present (CONF:CMS_92)</sch:assert>
      </sch:rule>
      <sch:rule id="QRDA_Category_III_CMS-participant-LOC-associatedEntity-errors"
      ...
      <sch:rule id="QRDA_Category_III_CMS-participant-LOC-associatedEntity-id-errors"
      ...
      <sch:rule id="QRDA_Category_III_CMS-participant-LOC-associatedEntity-code-errors"
      ...
      <sch:rule id="QRDA_Category_III_CMS-participant-DEV-associatedEntity-errors"
                context="cda:ClinicalDocument[cda:templateId[@root='2.16.840.1.113883.10.20.27.1.2'][@extension='2019-05-01']]/cda:participant[@typeCode='DEV']/cda:associatedEntity">
      ...
      <sch:rule id="QRDA_Category_III_CMS-participant-DEV-associatedEntity-id-errors"
                context="cda:ClinicalDocument[cda:templateId[@root='2.16.840.1.113883.10.20.27.1.2'][@extension='2019-05-01']]/cda:participant[@typeCode='DEV']/cda:associatedEntity/cda:id">
      ...
      <sch:rule id="QRDA_Category_III_CMS-documentationOf-errors"
      ...
      <sch:rule id="QRDA_Category_III_CMS-documentationOf-serviceEvent-performer-assignedEntity-errors"
      ...
      <sch:rule id="QRDA_Category_III_CMS-documentationOf-serviceEvent-performer-assignedEntity-representedOrganization-errors"
         ...
         <sch:assert id="a-CMS_82-error"
                     test="$intendedRecipient-Doc != 'MIPS_GROUP' or ($intendedRecipient-Doc='MIPS_GROUP' and count(cda:id[@root='2.16.840.1.113883.4.2'][@extension])=1)">If ClinicalDocument/informationRecipient/intendedRecipient/id/@extension="MIPS_GROUP", then this representedOrganization SHALL contain exactly one [1..1] id such that it SHALL be the group's TIN (CONF:CMS_82).</sch:assert>
         <sch:assert id="a-CMS_83-error"
                     test="$intendedRecipient-Doc != 'MIPS_VIRTUALGROUP' or ($intendedRecipient-Doc='MIPS_VIRTUALGROUP' and count(cda:id['2.16.840.1.113883.3.249.5.2'][@extension])=1)">If ClinicalDocument/informationRecipient/intendedRecipient/id/@extension="MIPS_VIRTUALGROUP", then this representedOrganization SHALL contain exactly one [1..1] id such that it SHALL be the virtual group's Virtual Group Identifier (CONF:CMS_83).</sch:assert>
      </sch:rule>
      <sch:rule id="QRDA_Category_III_CMS-component-structuredBody-errors"
         ...
         <sch:assert id="a-4427-21394_C01-error"
                     test="count(cda:component[count(cda:section[cda:templateId[@root='2.16.840.1.113883.10.20.27.2.3'][@extension='2019-05-01']])=1])=1 or count(cda:component[count(cda:section[cda:templateId[@root='2.16.840.1.113883.10.20.27.2.4'][@extension='2017-06-01']])=1])=1 or count(cda:component[count(cda:section[cda:templateId[@root='2.16.840.1.113883.10.20.27.2.5'][@extension='2017-06-01']])=1])=1">This structuredBody SHALL contain at least a QRDA Category III Measure Section - CMS (V4), or an Improvement Activity Section (V2), or a Promoting Interoperability Section (V2) (CONF:4427-21394_C01).</sch:assert>
      </sch:rule>
  </sch:pattern>
  <sch:pattern id="Aggregate_count-pattern-errors">
      <sch:rule id="Aggregate_count-errors"
         ...
         <sch:assert id="a-77-17565-error"
                     test="count(cda:templateId[@root='2.16.840.1.113883.10.20.27.3.3'][not(@extension)])=1">SHALL contain exactly one [1..1] templateId (CONF:77-17565) such that it SHALL contain exactly one [1..1] @root="2.16.840.1.113883.10.20.27.3.3" (CONF:77-18095).</sch:assert>
      ...
      <sch:rule id="Aggregate_count-code-errors"
      ...
      <sch:rule id="Aggregate_count-value-errors"
      ...
      <sch:rule id="Aggregate_count-methodCode-errors"
      ...
      <sch:rule id="Aggregate_count-referenceRange-errors"
      ...
      <sch:rule id="Aggregate_count-referenceRange-observationRange-errors"
  ...
  <sch:pattern id="Continuous_variable_measure_value-pattern-errors">
      <sch:rule id="Continuous_variable_measure_value-errors"
         ...
         <sch:assert id="a-77-18096-error"
                     test="count(cda:templateId[@root='2.16.840.1.113883.10.20.27.3.2'][not(@extension)])=1">SHALL contain exactly one [1..1] templateId (CONF:77-18096) such that it SHALL contain exactly one [1..1] @root="2.16.840.1.113883.10.20.27.3.2" (CONF:77-18097).</sch:assert>
      ...
      <sch:rule id="Continuous_variable_measure_value-reference-errors"
      ...
      <sch:rule id="Continuous_variable_measure_value-reference-externalObservation-errors"
      ...
      <sch:rule id="Continuous_variable_measure_value-referenceRange-errors"
      ...
      <sch:rule id="Continuous_variable_measure_value-referenceRange-observationRange-errors"
  ...
  <sch:pattern id="Ethnicity_supp_data_element-pattern-errors">
      <sch:rule id="Ethnicity_supp_data_element-errors"
         ...
         <sch:assert id="a-3259-18120-error"
      ...
      <sch:rule id="Ethnicity_supp_data_element-code-errors"
      ...
      <sch:rule id="Ethnicity_supp_data_element-statusCode-errors"
  ...
  <sch:pattern id="Improvement_Activity_Performed_Reference_and_Result-pattern-errors">
      <sch:rule id="Improvement_Activity_Performed_Reference_and_Result-errors"
                context="cda:organizer[cda:templateId[@root='2.16.840.1.113883.10.20.27.3.33'][@extension='2016-09-01']]">
         ...
         <sch:assert id="a-3259-21421-error"
                     test="count(cda:component[count(cda:observation[cda:templateId[@root='2.16.840.1.113883.10.20.27.3.27'][@extension='2016-09-01']])=1])=1">SHALL contain exactly one [1..1] component (CONF:3259-21421) such that it SHALL contain exactly one [1..1] Measure Performed (identifier: urn:hl7ii:2.16.840.1.113883.10.20.27.3.27:2016-09-01) (CONF:3259-21426).</sch:assert>
      </sch:rule>
  </sch:pattern>
  <sch:pattern id="Improvement_Activity-pattern-errors">
      <sch:rule id="Improvement_Activity-errors"
                context="cda:section[cda:templateId[@root='2.16.840.1.113883.10.20.27.2.4'][@extension='2017-06-01']]">
         <sch:assert id="a-3338-21175-error"
                     test="count(cda:templateId[@root='2.16.840.1.113883.10.20.27.2.4'][@extension='2017-06-01'])=1">SHALL contain exactly one [1..1] templateId (CONF:3338-21175) such that it SHALL contain exactly one [1..1] @root="2.16.840.1.113883.10.20.27.2.4" (CONF:3338-21177). SHALL contain exactly one [1..1] @extension="2017-06-01" (CONF:3338-21398).</sch:assert>
         <sch:assert id="a-3338-21181-error"
         ...
         <sch:assert id="a-3338-21447-error"
                     test="count(cda:entry[cda:act[cda:templateId[@root='2.16.840.1.113883.10.20.17.3.8']]])=1">SHALL contain exactly one [1..1] entry (CONF:3338-21447) such that it SHALL contain exactly one [1..1] Reporting Parameters Act (identifier: urn:oid:2.16.840.1.113883.10.20.17.3.8) (CONF:3338-21448).</sch:assert>
      </sch:rule>
  </sch:pattern>
  <sch:pattern id="Measure_data-pattern-errors">
      <sch:rule id="Measure_data-errors"
                context="cda:observation[cda:templateId[@root='2.16.840.1.113883.10.20.27.3.5'][@extension='2016-09-01']]">
         ...
         <sch:assert id="a-3259-17619-error"
         ...
         <sch:assert id="a-3259-18239-error"
                     test="count(cda:reference[count(cda:externalObservation[count(cda:id)=1])=1])=1">SHALL contain exactly one [1..1] reference (CONF:3259-18239) such that it SHALL contain exactly one [1..1] externalObservation (CONF:3259-18240). This externalObservation SHALL contain exactly one [1..1] id (CONF:3259-18241).</sch:assert>
      </sch:rule>
      <sch:rule id="Measure_data-code-errors"
      ...
      <sch:rule id="Measure_data-statusCode-errors"
      ...
      <sch:rule id="Measure_data-value-errors"
  ...
  <sch:pattern id="Measure_Performed-pattern-errors">
      <sch:rule id="Measure_Performed-errors"
      ...
      <sch:rule id="Measure_Performed-code-errors"
      ...
      <sch:rule id="Measure_Performed-statusCode-errors"
  ...
  <sch:pattern id="Measure_Reference_and_Results-pattern-errors">
      <sch:rule id="Measure_Reference_and_Results-errors"
                context="cda:organizer[cda:templateId[@root='2.16.840.1.113883.10.20.27.3.1'][@extension='2016-09-01']]">
         ...
         <sch:assert id="a-3259-17890-error"
      ...
      <sch:rule id="Measure_Reference_and_Results-reference-externalDocument-code-errors"
  ...
  <sch:pattern id="Payer_Supplemental_Data_Element-pattern-errors">
      <sch:rule id="Payer_Supplemental_Data_Element-errors"
                context="cda:observation[cda:templateId[@root='2.16.840.1.113883.10.20.27.3.9'][@extension='2016-02-01']]">
         ...
         <sch:assert id="a-2226-18108-error"
      ...
      <sch:rule id="Payer_Supplemental_Data_Element-code-errors"
      ...
      <sch:rule id="Payer_Supplemental_Data_Element-statusCode-errors"
  ...
  <sch:pattern id="Performance_Rate-pattern-errors">
      <sch:rule id="Performance_Rate-errors"
      ...
      <sch:rule id="Performance_Rate-code-errors"
      ...
      <sch:rule id="Performance_Rate-statusCode-errors"
  ...
  <sch:pattern id="Performance_Rate_for_Proportion_Measure-pattern-errors">
      <sch:rule id="Performance_Rate_for_Proportion_Measure-errors"
                context="cda:observation[cda:templateId[@root='2.16.840.1.113883.10.20.27.3.14'][@extension='2016-09-01']]">
      ...
      <sch:rule id="Performance_Rate_for_Proportion_Measure-reference-externalObservation-errors"
      ...
      <sch:rule id="Performance_Rate_for_Proportion_Measure-reference-externalObservation-id-errors"
      ...
      <sch:rule id="Performance_Rate_for_Proportion_Measure-reference-externalObservation-code-errors"
      ...
      <sch:rule id="Performance_Rate_for_Proportion_Measure-referenceRange-errors"
      ...
      <sch:rule id="Performance_Rate_for_Proportion_Measure-referenceRange-observationRange-errors"
  ...
  <sch:pattern id="Postal_Code_Supplemental_Data_Element_V2-pattern-errors">
      <sch:rule id="Postal_Code_Supplemental_Data_Element_V2-errors"
         ...
         <sch:assert id="a-3259-18102-error"
      ...
      <sch:rule id="Postal_Code_Supplemental_Data_Element_V2-code-errors"
      ...
      <sch:rule id="Postal_Code_Supplemental_Data_Element_V2-statusCode-errors"
  ...
  <sch:pattern id="Promoting_Interoperability_Measure_Performed_Reference_and_Result-pattern-errors">
      <sch:rule id="Promoting_Interoperability_Measure_Performed_Reference_and_Result-errors"
         ...
         <sch:assert id="a-3259-21404-error"
      ...
      <sch:rule id="Promoting_Interoperability_Measure_Performed_Reference_and_Result_reference_externalDocument-errors"
         ...
         <sch:assert id="a-3259-21407-error"
                     test="count(cda:id[@root='2.16.840.1.113883.3.7031'][@extension])=1">This externalDocument SHALL contain exactly one [1..1] id (CONF:3259-21407) such that it SHALL contain exactly one [1..1] @root="2.16.840.1.113883.3.7031" (CONF:3259-21412). SHALL contain exactly one [1..1] @extension (CONF:3259-21413).</sch:assert>
      </sch:rule>
  </sch:pattern>
  <sch:pattern id="Promoting_Interoperability_Numerator_Denominator_Type_Measure_Denominator-pattern-errors">
      <sch:rule id="Promoting_Interoperability_Numerator_Denominator_Type_Measure_Denominator-errors"
         ...
         <sch:assert id="a-3259-21364-error"
      ...
      <sch:rule id="Promoting_Interoperability_Numerator_Denominator_Type_Measure_Denominator-code-errors"
      ...
      <sch:rule id="Promoting_Interoperability_Numerator_Denominator_Type_Measure_Denominator-statusCode-errors"
      ...
      <sch:rule id="Promoting_Interoperability_Numerator_Denominator_Type_Measure_Denominator-value-errors"
  ...
  <sch:pattern id="Promoting_Interoperability_Numerator_Denominator_Type_Measure_Numerator-pattern-errors">
      <sch:rule id="Promoting_Interoperability_Numerator_Denominator_Type_Measure_Numerator-errors"
         ...
         <sch:assert id="a-3259-21322-error"
      ...
      <sch:rule id="Promoting_Interoperability_Numerator_Denominator_Type_Measure_Numerator-code-errors"
      ...
      <sch:rule id="Promoting_Interoperability_Numerator_Denominator_Type_Measure_Numerator-statusCode-errors"
      ...
      <sch:rule id="Promoting_Interoperability_Numerator_Denominator_Type_Measure_Numerator-value-errors"
  ...
  <sch:pattern id="Promoting_Interoperability_Numerator_Denominator_Measure_Reference_and_Results-pattern-errors">
      <sch:rule id="Promoting_Interoperability_Numerator_Denominator_Measure_Reference_and_Results-errors"
      ...
      <sch:rule id="Promoting_Interoperability_Numerator_Denominator_Measure_Reference_and_Results_reference_externalDocument-errors"
         ...
         <sch:assert id="a-3338-21247-error"
                     test="count(cda:id[@root='2.16.840.1.113883.3.7031'][@extension])=1">This externalDocument SHALL contain exactly one [1..1] id (CONF:3338-21247) such that it  SHALL contain exactly one [1..1] @root="2.16.840.1.113883.3.7031" (CONF:3338-21402). SHALL contain exactly one [1..1] @extension (CONF:3338-21403).</sch:assert>
      </sch:rule>
  </sch:pattern>
  <sch:pattern id="Promoting_Interoperability-pattern-errors">
      <sch:rule id="Promoting_Interoperability-errors"
                context="cda:section[cda:templateId[@root='2.16.840.1.113883.10.20.27.2.5'][@extension='2017-06-01']]">
         <sch:assert id="a-3338-21231-error"
                     test="count(cda:templateId[@root='2.16.840.1.113883.10.20.27.2.5'][@extension='2017-06-01'])=1">SHALL contain exactly one [1..1] templateId (CONF:3338-21231) such that it SHALL contain exactly one [1..1] @root="2.16.840.1.113883.10.20.27.2.5" (CONF:3338-21233). SHALL contain exactly one [1..1] @extension="2017-06-01" (CONF:3338-21395).</sch:assert>
         <sch:assert id="a-3338-21440-error"
                     test="count(cda:entry[cda:act[cda:templateId[@root='2.16.840.1.113883.10.20.17.3.8']]])=1">SHALL contain exactly one [1..1] entry (CONF:3338-21440) such that it SHALL contain exactly one [1..1] Reporting Parameters Act (identifier: urn:oid:2.16.840.1.113883.10.20.17.3.8) (CONF:3338-21441).</sch:assert>
         <sch:assert id="a-3338-21438-error" test="count(cda:entry) &gt; 0">SHALL contain at least one [1..*] entry (CONF:3338-21438).</sch:assert>
         <sch:assert id="a-3338-21439-error"
  ...
  <sch:pattern id="QRDA_Category_III_Measure-pattern-errors">
      <sch:rule id="QRDA_Category_III_Measure-errors"
                context="cda:section[cda:templateId[@root='2.16.840.1.113883.10.20.27.2.1'][@extension='2017-06-01']]">
         <sch:assert id="a-3338-17284-error"
                     test="count(cda:templateId[@root='2.16.840.1.113883.10.20.27.2.1'][@extension='2017-06-01'])=1">SHALL contain exactly one [1..1] templateId (CONF:3338-17284) such that it SHALL contain exactly one [1..1] @root="2.16.840.1.113883.10.20.27.2.1" (CONF:3338-17285). SHALL contain exactly one [1..1] @extension="2017-06-01" (CONF:3338-21171).</sch:assert>
         <sch:assert id="a-3338-17906-error"
         ...
         <sch:assert id="a-3338-21445-error"
                     test="count(cda:entry[cda:act[cda:templateId[@root='2.16.840.1.113883.10.20.17.3.8']]])=1">SHALL contain exactly one [1..1] entry (CONF:3338-21445) such that it SHALL contain exactly one [1..1] Reporting Parameters Act (identifier: urn:oid:2.16.840.1.113883.10.20.17.3.8) (CONF:3338-21446).</sch:assert>
      </sch:rule>
  </sch:pattern>
  <sch:pattern id="QRDA_Category_III_Report-pattern-errors">
      <sch:rule id="QRDA_Category_III_Report-errors" context="cda:ClinicalDocument">
         ...
         <sch:assert id="a-3338-17208-error"
                     test="count(cda:templateId[@root='2.16.840.1.113883.10.20.27.1.1'][@extension='2017-06-01'])=1">SHALL contain exactly one [1..1] templateId (CONF:3338-17208) such that it SHALL contain exactly one [1..1] @root="2.16.840.1.113883.10.20.27.1.1" (CONF:3338-17209). SHALL contain exactly one [1..1] @extension="2017-06-01" (CONF:3338-21319).</sch:assert>
         ...
         <sch:assert id="a-3338-18156-error"
                     test="count(cda:author[count(cda:time)=1][count(cda:assignedAuthor)=1]) &gt; 0">SHALL contain at least one [1..*] author (CONF:3338-18156) such that it SHALL contain exactly one [1..1] time (CONF:3338-18158). SHALL contain exactly one [1..1] assignedAuthor (CONF:3338-18157).</sch:assert>
      ...
      <sch:rule id="QRDA_Category_III_Report-typeId-errors"
      ...
      <sch:rule id="QRDA_Category_III_Report-realmCode-errors"
      ...
      <sch:rule id="QRDA_Category_III_Report-code-errors"
      ...
      <sch:rule id="QRDA_Category_III_Report-languageCode-errors"
      ...
      <sch:rule id="QRDA_Category_III_Report-recordTarget-errors"
                context="cda:ClinicalDocument[cda:templateId[@root='2.16.840.1.113883.10.20.27.1.1'][@extension='2017-06-01']]/cda:recordTarget">
         <sch:assert id="a-3338-17232-error"
                     test="count(cda:patientRole[count(cda:id[@nullFlavor='NA'])=1])=1">This recordTarget SHALL contain exactly one [1..1] patientRole (CONF:3338-17232) such that it SHALL contain exactly one [1..1] id (CONF:3338-17233). This id SHALL contain exactly one [1..1] @nullFlavor="NA" (CONF:3338-17234).</sch:assert>
      </sch:rule>
      <sch:rule id="QRDA_Category_III_Report-author-assignedAuthor-errors"
         ...
         <sch:assert id="a-3338-19667-error"
                     test="count(cda:assignedPerson)=1 or count(cda:assignedAuthoringDevice)=1">There SHALL be exactly one assignedAuthor/assignedPerson or exactly one assignedAuthor/assignedAuthoringDevice (CONF:3338-19667).</sch:assert>
      </sch:rule>
      <sch:rule id="QRDA_Category_III_Report-author-assignedAuthor-representedOrganization-errors"
      ...
      <sch:rule id="QRDA_Category_III_Report-author-assignedAuthor-assignedAuthoringDevice-errors"
      ...
      <sch:rule id="QRDA_Category_III_Report-custodian-errors"
      ...
      <sch:rule id="QRDA_Category_III_Report-custodian-assignedCustodian-errors"
         ...
         <sch:assert id="a-3338-17215-error"
                     test="count(cda:representedCustodianOrganization)=1">This assignedCustodian SHALL contain exactly one [1..1] representedCustodianOrganization (CONF:3338-17215).</sch:assert>
      </sch:rule>
      <sch:rule id="QRDA_Category_III_Report-custodian-assignedCustodian-representedCustodianOrganization-errors"
      ...
      <sch:rule id="QRDA_Category_III_Report-legalAuthenticator-errors"
      ...
      <sch:rule id="QRDA_Category_III_Report-legalAuthenticator-signatureCode-errors"
      ...
      <sch:rule id="QRDA_Category_III_Report-legalAuthenticator-assignedEntity-representedOrganization-errors"
      ...
      <sch:rule id="QRDA_Category_III_Report-participant-associatedEntity-errors"
      ...
      <sch:rule id="QRDA_Category_III_Report-participant-associatedEntity-code-errors"
      ...
      <sch:rule id="QRDA_Category_III_Report-documentationOf-errors"
      ...
      <sch:rule id="QRDA_Category_III_Report-documentationOf-serviceEvent-errors"
      ...
      <sch:rule id="QRDA_Category_III_Report-documentationOf-serviceEvent-performer-errors"
      ...
      <sch:rule id="QRDA_Category_III_Report-documentationOf-serviceEvent-performer-assignedEntity-errors"
      ...
      <sch:rule id="QRDA_Category_III_Report-authorization-errors"
      ...
      <sch:rule id="QRDA_Category_III_Report-authorization-consent-errors"
      ...
      <sch:rule id="QRDA_Category_III_Report-authorization-consent-code-errors"
      ...
      <sch:rule id="QRDA_Category_III_Report-authorization-consent-statusCode-errors"
      ...
      <sch:rule id="QRDA_Category_III_Report-component-errors"
      ...
      <sch:rule id="QRDA_Category_III_Report-component-structuredBody-errors"
         ...
         <sch:assert id="a-3338-21394-error"
                     test="count(cda:component[count(cda:section[cda:templateId[@root='2.16.840.1.113883.10.20.27.2.1'][@extension='2017-06-01']])=1])=1 or count(cda:component[count(cda:section[cda:templateId[@root='2.16.840.1.113883.10.20.27.2.4'][@extension='2017-06-01']])=1])=1 or count(cda:component[count(cda:section[cda:templateId[@root='2.16.840.1.113883.10.20.27.2.5'][@extension='2017-06-01']])=1])=1">This structuredBody SHALL contain at least a QRDA Category III Measure Section (V4), or an Improvement Activity Section (V2), or an Advancing Care Information Section (V2) (CONF:3338-21394).</sch:assert>
      </sch:rule>
  </sch:pattern>
  <sch:pattern id="QRDA_Category_III_Reporting_Parameters-pattern-errors">
      <sch:rule id="QRDA_Category_III_Reporting_Parameters-errors"
                context="cda:section[cda:templateId[@root='2.16.840.1.113883.10.20.27.2.2']]">
         <sch:assert id="a-77-18323-error"
                     test="count(cda:templateId[@root='2.16.840.1.113883.10.20.27.2.2'][not(@extension)])=1">SHALL contain exactly one [1..1] templateId (CONF:77-18323) such that it SHALL contain exactly one [1..1] @root="2.16.840.1.113883.10.20.27.2.2" (CONF:77-18324).</sch:assert>
         <sch:assert id="a-77-18325-error"
  ...
  <sch:pattern id="Race_Supplemental_Data_Element-pattern-errors">
      <sch:rule id="Race_Supplemental_Data_Element-errors"
         ...
         <sch:assert id="a-3259-18114-error"
      ...
      <sch:rule id="Race_Supplemental_Data_Element-code-errors"
      ...
      <sch:rule id="Race_Supplemental_Data_Element-statusCode-errors"
  ...
  <sch:pattern id="Reporting_Rate_for_Proportion_Measure-pattern-errors">
      <sch:rule id="Reporting_Rate_for_Proportion_Measure-errors"
         ...
         <sch:assert id="a-77-21157-error"
                     test="count(cda:templateId[@root='2.16.840.1.113883.10.20.27.3.15'][not(@extension)])=1">SHALL contain exactly one [1..1] templateId (CONF:77-21157) such that it SHALL contain exactly one [1..1] @root="2.16.840.1.113883.10.20.27.3.15" (CONF:77-21158).</sch:assert>
      ...
      <sch:rule id="Reporting_Rate_for_Proportion_Measure-code-errors"
      ...
      <sch:rule id="Reporting_Rate_for_Proportion_Measure-statusCode-errors"
      ...
      <sch:rule id="Reporting_Rate_for_Proportion_Measure-referenceRange-errors"
      ...
      <sch:rule id="Reporting_Rate_for_Proportion_Measure-referenceRange-observationRange-errors"
  ...
  <sch:pattern id="Reporting_Stratum-pattern-errors">
      <sch:rule id="Reporting_Stratum-errors"
         ...
         <sch:assert id="a-77-18093-error"
                     test="count(cda:templateId[@root='2.16.840.1.113883.10.20.27.3.4'][not(@extension)])=1">SHALL contain exactly one [1..1] templateId (CONF:77-18093) such that it SHALL contain exactly one [1..1] @root="2.16.840.1.113883.10.20.27.3.4" (CONF:77-18094).</sch:assert>
      ...
      <sch:rule id="Reporting_Stratum-code-errors"
      ...
      <sch:rule id="Reporting_Stratum-statusCode-errors"
      ...
      <sch:rule id="Reporting_Stratum-reference-errors"
      ...
      <sch:rule id="Reporting_Stratum-reference-externalObservation-errors"
  ...
  <sch:pattern id="Service_Encounter-pattern-errors">
      <sch:rule id="Service_Encounter-errors"
         ...
         <sch:assert id="a-77-18369-error"
                     test="count(cda:templateId[@root='2.16.840.1.113883.10.20.27.3.11'][not(@extension)])=1">SHALL contain exactly one [1..1] templateId (CONF:77-18369) such that it SHALL contain exactly one [1..1] @root="2.16.840.1.113883.10.20.27.3.11" (CONF:77-18370).</sch:assert>
  ...
  <sch:pattern id="Sex_Supplemental_Data_Element-pattern-errors">
      <sch:rule id="Sex_Supplemental_Data_Element-errors"
         ...
         <sch:assert id="a-3259-18126-error"
      ...
      <sch:rule id="Sex_Supplemental_Data_Element-code-errors"
      ...
      <sch:rule id="Sex_Supplemental_Data_Element-statusCode-errors"
  ...
  <sch:pattern id="Improvement_Activity_Performed_Reference_and_Result-pattern-warnings">
      <sch:rule id="Improvement_Activity_Performed_Reference_and_Result-warnings"
  ...
  <sch:pattern id="Measure_Reference-pattern-warnings">
      <sch:rule id="Measure_Reference-reference-externalDocument-warnings"
  ...
  <sch:pattern id="Promoting_Interoperability_Measure_Performed_Reference_and_Result-pattern-warnings">
      <sch:rule id="Promoting_Interoperability_Measure_Performed_Reference_and_Result_reference_externalDocument-warnings"
                context="cda:organizer[cda:templateId[@root='2.16.840.1.113883.10.20.27.3.29'][@extension='2016-09-01']]/cda:reference/cda:externalDocument">
  ...
  <sch:pattern id="Promoting_Interoperability_Numerator_Denominator_Measure_Reference_and_Results-pattern-warnings">
      <sch:rule id="Promoting_Interoperability_Numerator_Denominator_Measure_Reference_and_Results-reference-externalDocument-warnings"
                context="cda:organizer[cda:templateId[@root='2.16.840.1.113883.10.20.27.3.28'][@extension='2017-06-01']]/cda:reference/cda:externalDocument">
  ...
  <sch:pattern id="QRDA_Category_III_Report-pattern-warnings">
      <sch:rule id="QRDA_Category_III_Report-warnings"
                context="cda:ClinicalDocument[cda:templateId[@root='2.16.840.1.113883.10.20.27.1.1'][@extension='2017-06-01']]">
         <sch:assert id="a-3338-17238-v-warning"
      ...
      <sch:rule id="QRDA_Category_III_Report-custodian-assignedCustodian-representedCustodianOrganization-warnings"
                context="cda:ClinicalDocument[cda:templateId[@root='2.16.840.1.113883.10.20.27.1.1'][@extension='2017-06-01']]/cda:custodian/cda:assignedCustodian/cda:representedCustodianOrganization">
      ...
      <sch:rule id="QRDA_Category_III_Report-legalAuthenticator-assignedEntity-representedOrganization-warnings"
                context="cda:ClinicalDocument[cda:templateId[@root='2.16.840.1.113883.10.20.27.1.1'][@extension='2017-06-01']]/cda:legalAuthenticator/cda:assignedEntity/cda:representedOrganization">
      ...
      <sch:rule id="QRDA_Category_III_Report-documentationOf-serviceEvent-performer-assignedEntity-representedOrganization-warnings"
  ...
  <sch:pattern id="Reporting_Stratum-pattern-warnings">
      <sch:rule id="Reporting_Stratum-warnings"
                context="cda:observation[cda:templateId[@root='2.16.840.1.113883.10.20.27.3.4']]">
