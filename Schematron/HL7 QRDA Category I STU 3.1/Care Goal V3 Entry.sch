...
<sch:schema xmlns:voc="http://www.lantanagroup.com/voc" xmlns:svs="urn:ihe:iti:svs:2008" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:sdtc="urn:hl7-org:sdtc" xmlns="urn:hl7-org:v3" xmlns:cda="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
    ...
    <sch:pattern id="Care-Goal-V3-pattern-errors">
        <sch:rule id="Care-Goal-V3-errors" context="cda:observation[cda:templateId[@root='2.16.840.1.113883.10.20.24.3.1']]">
            ...
            <sch:assert id="a-2228-11646" test="count(cda:entryRelationship[@typeCode='REFR'][count(cda:observation[@classCode='OBS'][@moodCode='EVN'][count(cda:code)=1][count(cda:value[@xsi:type='CD'][@sdtc:valueSet])=1])=1]) &lt;=1">  
                MAY contain zero or one [0..1] entryRelationship (CONF:2228-11646) 
                such that it 
                SHALL contain exactly one [1..1] @typeCode="REFR" refers to (CodeSystem: HL7ActRelationshipType urn:oid:2.16.840.1.113883.5.1002) (CONF:2228-13876). 
                SHALL contain exactly one [1..1] observation (CONF:2228-11647)
                This observation SHALL contain exactly one [1..1] @classCode="OBS" (CodeSystem: HL7ActClass urn:oid:2.16.840.1.113883.5.6) (CONF:2228-11648).
                This observation SHALL contain exactly one [1..1] @moodCode="EVN" (CodeSystem: ActMood urn:oid:2.16.840.1.113883.5.1001) (CONF:2228-11649).
                This observation SHALL contain exactly one [1..1] code (CONF:2228-28041).
                This observation SHALL contain exactly one [1..1] value with @xsi:type="CD" (CONF:2228-11650).
                This value SHALL contain exactly one [1..1] @sdtc:valueSet (CONF:2228-28042).
              </sch:assert> 
            <sch:assert id="a-2228-28036" test="count(cda:entryRelationship[@typeCode='REFR']
                [count(cda:observation[cda:templateId[@root='2.16.840.1.113883.10.20.24.3.119' and @extension = '2014-12-01']])=1]
                ) &lt;=1"> 
                MAY contain zero or one [0..1] entryRelationship (CONF:2228-28036) Note: QDM Attribute: Targeted Outcome 
                such that it 
                SHALL contain exactly one [1..1] @typeCode="REFR" Refers to (CodeSystem: HL7ActRelationshipType urn:oid:2.16.840.1.113883.5.1002) (CONF:2228-28037) 
                SHALL contain exactly one [1..1] Target Outcome (identifier: urn:hl7ii:2.16.840.1.113883.10.20.24.3.119:2014-12-01) (CONF:2228-28038).
            </sch:assert> 
        </sch:rule>
        ...
        <sch:rule id="Care-Goal-V3-effectiveTime-errors" context="cda:observation[cda:templateId[@root='2.16.840.1.113883.10.20.24.3.1']]/cda:effectiveTime">
            <sch:assert id="a-2228-27557" test="count(cda:low)=1">This effectiveTime SHALL contain exactly one [1..1] low (CONF:2228-27557). Note: QDM Attribute: Start Datetime</sch:assert>
        </sch:rule>
    </sch:pattern>
