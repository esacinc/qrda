...
<sch:schema xmlns:voc="http://www.lantanagroup.com/voc" xmlns:svs="urn:ihe:iti:svs:2008" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:sdtc="urn:hl7-org:sdtc" xmlns="urn:hl7-org:v3" xmlns:cda="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
    ...
    <sch:pattern id="Comm-Provider-To-Patient-V3-pattern-errors">
        <sch:rule id="Comm-Provider-To-Patient-V3-errors" context="cda:act[cda:templateId[@root='2.16.840.1.113883.10.20.24.3.3']]">
            ...
            <sch:assert id="a-2228-28044" test="count(@negationInd)&lt;=1">MAY contain zero or one [0..1] @negationInd (CONF:2228-28044).</sch:assert>
            ...
            <sch:assert id="a-2228-11845" test="count(cda:id)&gt;=1">SHALL contain at least one [1..*] id (CONF:2228-11845).</sch:assert>
        ...
        <sch:rule id="Comm-Provider-To-Patient-V3-code-errors" context="cda:act[cda:templateId[@root='2.16.840.1.113883.10.20.24.3.3']]/cda:code">
            <sch:assert id="a-2228-27579" test="@sdtc:valueSet">This code SHALL contain exactly one [1..1] @sdtc:valueSet (CONF:2228-27579).</sch:assert>
        </sch:rule>
        <sch:rule id="Comm-Provider-To-Patient-V3-effectiveTime-errors" context="cda:act[cda:templateId[@root='2.16.840.1.113883.10.20.24.3.3']]/cda:effectiveTime">
            <sch:assert id="a-2228-27545" test="count(cda:low)=1">This effectiveTime SHALL contain exactly one [1..1] low (CONF:2228-27545). </sch:assert>
            <sch:assert id="a-2228-27546" test="count(cda:high)&lt;=1">This effectiveTime MAY contain zero or one [0..1] high (CONF:2228-27546). </sch:assert>
        </sch:rule>
    </sch:pattern>
