...
<sch:schema xmlns:svs="urn:ihe:iti:svs:2008" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:sdtc="urn:hl7-org:sdtc" xmlns="urn:hl7-org:v3" xmlns:cda="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
	...
	<sch:phase id="errors">
		<sch:active pattern="HQR_CMS_QRDA_Category_I-pattern-errors" />
	</sch:phase>
	<sch:pattern id="HQR_CMS_QRDA_Category_I-pattern-errors">
		<sch:rule id="HQR_CMS_QRDA_Category_I_Reporting_Param-errors" context='cda:section[cda:templateId[@root="2.16.840.1.113883.10.20.17.2.1.1"]]'>
			...
			<sch:assert id="a-CMS_0023-error" test='count(cda:entry[cda:act[cda:templateId[@root="2.16.840.1.113883.10.20.17.3.8.1"][@extension="2016-03-01"]]]) = 1'>
