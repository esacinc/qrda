...
<sch:schema xmlns:svs="urn:ihe:iti:svs:2008" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:sdtc="urn:hl7-org:sdtc" xmlns="urn:hl7-org:v3" xmlns:cda="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
	...
	<sch:pattern id='Intervention_Intolerance_V3-pattern-errors'>
		<sch:rule id='Intervention_Intolerance_V3-errors' context='cda:observation[cda:templateId[@root="2.16.840.1.113883.10.20.24.3.30"]]'>
			...
			<sch:assert id='a-2228-13679-error' test='count(cda:entryRelationship[@typeCode="CAUS"][@inversionInd="true"][cda:act[count(cda:templateId[@root="2.16.840.1.113883.10.20.24.3.32"][@extension="2016-02-01"])=1]])=1'>
