...
<sch:schema xmlns:voc="http://www.lantanagroup.com/voc" xmlns:svs="urn:ihe:iti:svs:2008" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:sdtc="urn:hl7-org:sdtc" xmlns="urn:hl7-org:v3" xmlns:cda="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
    ...
    <sch:phase id="errors">
        <sch:active pattern="Transfer-Form-pattern-errors" />
    </sch:phase>
    
    <sch:phase id="warnings">
        <sch:active pattern="Transfer-Form-pattern-warnings" />
    </sch:phase>
    
    <sch:pattern id="Transfer-Form-pattern-errors">
        <sch:rule id="Transfer-Form-errors" context="cda:encounter[cda:templateId[@root='2.16.840.1.113883.10.20.24.3.81']]">
        ...
        <sch:rule id="Transfer-Form-code-errors" context="cda:encounter[cda:templateId[@root='2.16.840.1.113883.10.20.24.3.81']]/cda:code">
        ...
        <sch:rule id="Transfer-Form-statusCode-errors" context="cda:encounter[cda:templateId[@root='2.16.840.1.113883.10.20.24.3.81']]/cda:statusCode">
        ...
        <sch:rule id="Transfer-Form-participant-time-errors" context="cda:encounter[cda:templateId[@root='2.16.840.1.113883.10.20.24.3.81']]/cda:paticipant/cda:time">
        ...
        <sch:rule id="Transfer-Form-participantRole-errors" context="cda:encounter[cda:templateId[@root='2.16.840.1.113883.10.20.24.3.81']]/cda:participantRole">
    ...
    <sch:pattern id="Transfer-Form-pattern-warnings">
    </sch:pattern>
</sch:schema>