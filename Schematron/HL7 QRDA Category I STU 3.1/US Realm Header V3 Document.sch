...
<sch:schema xmlns:voc="http://www.lantanagroup.com/voc" xmlns:svs="urn:ihe:iti:svs:2008" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:sdtc="urn:hl7-org:sdtc" xmlns="urn:hl7-org:v3" xmlns:cda="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
    ...
    <sch:pattern id="US_Realm-pattern-errors">
        ...
        <sch:rule id="QRDA_Category_I_V3-versionNumber-errors" context="cda:ClinicalDocument/cda:versionNumber">
        ...
        <sch:rule id="QRDA_Category_I_V3-recordTarget-patientRole-errors" context="cda:ClinicalDocument/cda:recordTarget/cda:patientRole">
        ...
        <sch:rule id="QRDA_Category_I_V3-recordTarget-patientRole-patient-errors" context="cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient">
        ...
        <sch:rule id="QRDA_Category_I_V3-recordTarget-patientRole-patient-birthTime-errors" context="cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient/cda:birthTime">
            <sch:assert id="a-1198-5299" test="string-length(@value) &gt;= 4">SHALL be precise to year (CONF:1198-5299).</sch:assert>
        </sch:rule>
        <sch:rule id="QRDA_Category_I_V3-recordTarget-patientRole-patient-raceCode-errors" context="cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient/sdtc:raceCode">
        ...
        <sch:rule id="QRDA_Category_I_V3-recordTarget-patientRole-patient-guardian-errors" context="cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient/cda:guardian">
        ...
        <sch:rule id="QRDA_Category_I_V3-recordTarget-patientRole-patient-guardian-guardianPerson-errors" context="cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient/cda:guardian/cda:guardianPerson">
        ...
        <sch:rule id="QRDA_Category_I_V3-recordTarget-patientRole-patient-birthplace-errors" context="cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient/cda:birthplace">
        ...
        <sch:rule id="QRDA_Category_I_V3-recordTarget-patientRole-patient-birthplace-place-errors" context="cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient/cda:birthplace/cda:place">
            <sch:assert id="a-1198-5397" test="count(cda:addr)=1">This place SHALL contain exactly one [1..1] addr (CONF:1198-5397).</sch:assert>
        </sch:rule>
        <sch:rule id="QRDA_Category_I_V3-recordTarget-patientRole-patient-languageCommunication-errors" context="cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient/cda:languageCommunication">
        ...
        <sch:rule id="QRDA_Category_I_V3-recordTarget-patientRole-providerOrganization-errors" context="cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:providerOrganization">
        ...
        <sch:rule id="QRDA_Category_I_V3-author-errors" context="cda:ClinicalDocument/cda:author">
        ...
        <sch:rule id="QRDA_Category_I_V3-author-assignedAuthor-errors" context="cda:ClinicalDocument/cda:author/cda:assignedAuthor">
        ...
        <sch:rule id="QRDA_Category_I_V3-author-assignedAuthor-assignedAuthoringDevice-errors" context="cda:ClinicalDocument/cda:author/cda:assignedAuthor/cda:assignedAuthoringDevice">
        ...
        <sch:rule id="QRDA_Category_I_V3-dataEnterer-errors" context="cda:ClinicalDocument/cda:dataEnterer">
        ...
        <sch:rule id="QRDA_Category_I_V3-dataEnterer-assignedEntity-errors" context="cda:ClinicalDocument/cda:dataEnterer/cda:assignedEntity">
        ...
        <sch:rule id="QRDA_Category_I_V3-dataEnterer-assignedEntity-assignedPerson-errors" context="cda:ClinicalDocument/cda:dataEnterer/cda:assignedEntity/cda:assignedPerson">
        ...
        <sch:rule id="QRDA_Category_I_V3-informant-errors" context="cda:ClinicalDocument/cda:informant">
        ...
        <sch:rule id="QRDA_Category_I_V3-informant-assignedEntity-errors" context="cda:ClinicalDocument/cda:informant/cda:assignedEntity">
        ...
        <sch:rule id="QRDA_Category_I_V3-informant-assignedEntity-assignedPerson-errors" context="cda:ClinicalDocument/cda:informant/cda:assignedEntity/cda:assignedPerson">
        ...
        <sch:rule id="QRDA_Category_I_V3-custodian-errors" context="cda:ClinicalDocument/cda:custodian">
        ...
        <sch:rule id="QRDA_Category_I_V3-custodian-assignedCustodian-errors" context="cda:ClinicalDocument/cda:custodian/cda:assignedCustodian">
        ...
        <sch:rule id="QRDA_Category_I_V3-custodian-assignedCustodian-representedCustodianOrganization-errors" context="cda:ClinicalDocument/cda:custodian/cda:assignedCustodian/cda:representedCustodianOrganization">
        ...
        <sch:rule id="QRDA_Category_I_V3-informationRecipient-errors" context="cda:ClinicalDocument/cda:informationRecipient">
        ...
        <sch:rule id="QRDA_Category_I_V3-informationRecipient-intendedRecipient-informationRecipient-errors" context="cda:ClinicalDocument/cda:informationRecipient/cda:intendedRecipient/cda:informationRecipient">
        ...
        <sch:rule id="QRDA_Category_I_V3-informationRecipient-intendedRecipient-receivedOrganization-errors" context="cda:ClinicalDocument/cda:informationRecipient/cda:intendedRecipient/cda:receivedOrganization">
        ...
        <sch:rule id="QRDA_Category_I_V3-legalAuthenticator-errors" context="cda:ClinicalDocument/cda:legalAuthenticator">
        ...
        <sch:rule id="QRDA_Category_I_V3-legalAuthenticator-assignedEntity-assignedPerson-errors" context="cda:ClinicalDocument/cda:legalAuthenticator/cda:assignedEntity/cda:assignedPerson">
        ...
        <sch:rule id="QRDA_Category_I_V3-authenticator-errors" context="cda:ClinicalDocument/cda:authenticator">
        ...
        <sch:rule id="QRDA_Category_I_V3-authenticator-assignedEntity-assignedPerson-errors" context="cda:ClinicalDocument/cda:authenticator/cda:assignedEntity/cda:assignedPerson">
        ...
        <sch:rule id="QRDA_Category_I_V3-participant-errors" context="cda:ClinicalDocument/cda:participant">
        ...
        <sch:rule id="QRDA_Category_I_V3-inFulfillmentOf-errors" context="cda:ClinicalDocument/cda:inFulfillmentOf">
        ...
        <sch:rule id="QRDA_Category_I_V3-inFulfillmentOf-order-errors" context="cda:ClinicalDocument/cda:inFulfillmentOf/cda:order">
            <sch:assert id="a-1198-9954" test="count(cda:id) &gt; 0">This order SHALL contain at least one [1..*] id (CONF:1198-9954).</sch:assert>
        </sch:rule>
        <sch:rule id="QRDA_Category_I_V3-documentationOf-errors" context="cda:ClinicalDocument/cda:documentationOf">
        ...
        <sch:rule id="QRDA_Category_I_V3-documentationOf-serviceEvent-errors" context="cda:ClinicalDocument/cda:documentationOf/cda:serviceEvent">
        ...
        <sch:rule id="QRDA_Category_I_V3-documentationOf-serviceEvent-effectiveTime-errors" context="cda:ClinicalDocument/cda:documentationOf/cda:serviceEvent/cda:effectiveTime">
        ...
        <sch:rule id="QRDA_Category_I_V3-authorization-errors" context="cda:ClinicalDocument/cda:authorization">
            <sch:assert id="a-1198-16793" test="count(cda:consent)=1">SHALL contain exactly one [1..1] consent (CONF:1198-16793).</sch:assert>
        </sch:rule>
        <sch:rule id="QRDA_Category_I_V3-authorization-consent-errors" context="cda:ClinicalDocument/cda:authorization/cda:consent">
        ...
        <sch:rule id="QRDA_Category_I_V3-componentOf-encompassingEncounter-errors" context="cda:ClinicalDocument/cda:componentOf/cda:encompassingEncounter">
    ...
    <sch:pattern id="US_Realm-pattern-warnings">
        <sch:rule id="QRDA_Category_I_V3-warnings" context="cda:ClinicalDocument">
        ...
        <sch:rule id="QRDA_Category_I_V3-recordTarget-patientRole-patient-birthTime-warnings" context="cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient/cda:birthTime">
            <sch:assert id="a-1198-5300" test="string-length(@value) &gt;= 8">SHOULD be precise to day (CONF:1198-5300).</sch:assert>
        </sch:rule>
        <sch:rule id="QRDA_Category_I_V3-recordTarget-patientRole-patient-guardian-warnings" context="cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient/cda:guardian">
        ...
        <sch:rule id="QRDA_Category_I_V3-recordTarget-patientRole-patient-languageCommunication-warnings" context="cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient/cda:languageCommunication">
        ...
        <sch:rule id="QRDA_Category_I_V3-author-assignedAuthor-assignedPerson-warnings" context="cda:ClinicalDocument/cda:author/cda:assignedAuthor/cda:assignedPerson">
        ...
        <sch:rule id="QRDA_Category_I_V3-documentationOf-serviceEvent-warnings" context="cda:ClinicalDocument/cda:documentationOf/cda:serviceEvent">
