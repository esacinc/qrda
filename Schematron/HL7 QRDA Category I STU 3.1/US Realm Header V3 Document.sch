...
<sch:schema xmlns:voc="http://www.lantanagroup.com/voc" xmlns:svs="urn:ihe:iti:svs:2008" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:sdtc="urn:hl7-org:sdtc" xmlns="urn:hl7-org:v3" xmlns:cda="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
    ...
    <sch:pattern id="US_Realm-pattern-errors">
        ...
        <sch:rule id="US_Realm-typeId-errors" context="cda:ClinicalDocument/cda:typeId">
        ...
        <sch:rule id="US_Realm-setId-errors" context="cda:ClinicalDocument/cda:setId">
        ...
        <sch:rule id="US_Realm-versionNumber-errors" context="cda:ClinicalDocument/cda:versionNumber">
        ...
        <sch:rule id="US_Realm-recordTarget-errors" context="cda:ClinicalDocument/cda:recordTarget">
        ...
        <sch:rule id="US_Realm-recordTarget-patientRole-errors" context="cda:ClinicalDocument/cda:recordTarget/cda:patientRole">
        ...
        <sch:rule id="US_Realm-recordTarget-patientRole-patient-errors" context="cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient">
        ...
        <sch:rule id="US_Realm-recordTarget-patientRole-patient-birthTime-errors" context="cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient/cda:birthTime">
            <sch:assert id="a-1198-5299" test="string-length(@value) &gt;= 4">SHALL be precise to year (CONF:1198-5299).</sch:assert>
        </sch:rule>
        <sch:rule id="US_Realm-recordTarget-patientRole-patient-raceCode-errors" context="cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient/sdtc:raceCode">
        ...
        <sch:rule id="US_Realm-recordTarget-patientRole-patient-guardian-errors" context="cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient/cda:guardian">
        ...
        <sch:rule id="US_Realm-recordTarget-patientRole-patient-guardian-guardianPerson-errors" context="cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient/cda:guardian/cda:guardianPerson">
        ...
        <sch:rule id="US_Realm-recordTarget-patientRole-patient-birthplace-errors" context="cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient/cda:birthplace">
        ...
        <sch:rule id="US_Realm-recordTarget-patientRole-patient-birthplace-place-errors" context="cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient/cda:birthplace/cda:place">
            <sch:assert id="a-1198-5397" test="count(cda:addr)=1">This place SHALL contain exactly one [1..1] addr (CONF:1198-5397).</sch:assert>
        </sch:rule>
        <sch:rule id="US_Realm-recordTarget-patientRole-patient-languageCommunication-errors" context="cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient/cda:languageCommunication">
        ...
        <sch:rule id="US_Realm-recordTarget-patientRole-providerOrganization-errors" context="cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:providerOrganization">
        ...
        <sch:rule id="US_Realm-author-errors" context="cda:ClinicalDocument/cda:author">
        ...
        <sch:rule id="US_Realm-author-assignedAuthor-errors" context="cda:ClinicalDocument/cda:author/cda:assignedAuthor">
        ...
        <sch:rule id="US_Realm-author-assignedAuthor-code-errors" context="cda:ClinicalDocument/cda:author/cda:assignedAuthor/cda:code">
        ...
        <sch:rule id="US_Realm-author-assignedAuthor-assignedPerson-errors" context="cda:ClinicalDocument/cda:author/cda:assignedAuthor/cda:assignedPerson">
        ...
        <sch:rule id="US_Realm-author-assignedAuthor-assignedAuthoringDevice-errors" context="cda:ClinicalDocument/cda:author/cda:assignedAuthor/cda:assignedAuthoringDevice">
        ...
        <sch:rule id="US_Realm-dataEnterer-errors" context="cda:ClinicalDocument/cda:dataEnterer">
        ...
        <sch:rule id="US_Realm-dataEnterer-assignedEntity-errors" context="cda:ClinicalDocument/cda:dataEnterer/cda:assignedEntity">
        ...
        <sch:rule id="US_Realm-dataEnterer-assignedEntity-assignedPerson-errors" context="cda:ClinicalDocument/cda:dataEnterer/cda:assignedEntity/cda:assignedPerson">
        ...
        <sch:rule id="US_Realm-informant-errors" context="cda:ClinicalDocument/cda:informant">
            <sch:assert id="a-1198-8002" test="count(cda:assignedEntity)=1">SHALL contain exactly one [1..1] assignedEntity (CONF:1198-8002).</sch:assert>
            <sch:assert id="a-1198-31356" test="count(cda:relatedEntity)=1">SHALL contain exactly one [1..1] relatedEntity (CONF:1198-31356).</sch:assert>
        </sch:rule>
        <sch:rule id="US_Realm-informant-assignedEntity-errors" context="cda:ClinicalDocument/cda:informant/cda:assignedEntity">
            <sch:assert id="a-1198-9945" test="count(cda:id) &gt; 0">This assignedEntity SHALL contain at least one [1..*] id (CONF:1198-9945).</sch:assert>
            <sch:assert id="a-1198-8220" test="count(cda:addr) &gt; 0">This assignedEntity SHALL contain at least one [1..*] US Realm Address (AD.US.FIELDED) (identifier: urn:oid:2.16.840.1.113883.10.20.22.5.2) (CONF:1198-8220).</sch:assert>
            <sch:assert id="a-1198-8221" test="count(cda:assignedPerson)=1">This assignedEntity SHALL contain exactly one [1..1] assignedPerson (CONF:1198-8221).</sch:assert>
        </sch:rule>
        <sch:rule id="US_Realm-informant-assignedEntity-assignedPerson-errors" context="cda:ClinicalDocument/cda:informant/cda:assignedEntity/cda:assignedPerson">
            <sch:assert id="a-1198-8222" test="count(cda:name) &gt; 0">This assignedPerson SHALL contain at least one [1..*] US Realm Person Name (PN.US.FIELDED) (identifier: urn:oid:2.16.840.1.113883.10.20.22.5.1.1) (CONF:1198-8222).</sch:assert>
        </sch:rule>
        <sch:rule id="US_Realm-custodian-errors" context="cda:ClinicalDocument/cda:custodian">
        ...
        <sch:rule id="US_Realm-custodian-assignedCustodian-errors" context="cda:ClinicalDocument/cda:custodian/cda:assignedCustodian">
        ...
        <sch:rule id="US_Realm-custodian-assignedCustodian-representedCustodianOrganization-errors" context="cda:ClinicalDocument/cda:custodian/cda:assignedCustodian/cda:representedCustodianOrganization">
        ...
        <sch:rule id="US_Realm-informationRecipient-errors" context="cda:ClinicalDocument/cda:informationRecipient">
        ...
        <sch:rule id="US_Realm-informationRecipient-intendedRecipient-informationRecipient-errors" context="cda:ClinicalDocument/cda:informationRecipient/cda:intendedRecipient/cda:informationRecipient">
        ...
        <sch:rule id="US_Realm-informationRecipient-intendedRecipient-receivedOrganization-errors" context="cda:ClinicalDocument/cda:informationRecipient/cda:intendedRecipient/cda:receivedOrganization">
        ...
        <sch:rule id="US_Realm-legalAuthenticator-errors" context="cda:ClinicalDocument/cda:legalAuthenticator">
        ...
        <sch:rule id="US_Realm-legalAuthenticator-signatureCode-errors" context="cda:ClinicalDocument/cda:legalAuthenticator/cda:signatureCode">
        ...
        <sch:rule id="US_Realm-legalAuthenticator-assignedEntity-errors" context="cda:ClinicalDocument/cda:legalAuthenticator/cda:assignedEntity">
        ...
        <sch:rule id="US_Realm-legalAuthenticator-assignedEntity-assignedPerson-errors" context="cda:ClinicalDocument/cda:legalAuthenticator/cda:assignedEntity/cda:assignedPerson">
        ...
        <sch:rule id="US_Realm-authenticator-errors" context="cda:ClinicalDocument/cda:authenticator">
            <sch:assert id="a-1198-5608" test="count(cda:time)=1">SHALL contain exactly one [1..1] US Realm Date and Time (DTM.US.FIELDED) (identifier: urn:oid:2.16.840.1.113883.10.20.22.5.4) (CONF:1198-5608).</sch:assert>
            <sch:assert id="a-1198-5610" test="count(cda:signatureCode)=1">SHALL contain exactly one [1..1] signatureCode (CONF:1198-5610).</sch:assert>
        ...
        <sch:rule id="US_Realm-authenticator-signatureCode-errors" context="cda:ClinicalDocument/cda:authenticator/cda:signatureCode">
        ...
        <sch:rule id="US_Realm-authenticator-assignedEntity-errors" context="cda:ClinicalDocument/cda:authenticator/cda:assignedEntity">
            ...
            <sch:assert id="a-1198-5616" test="count(cda:addr) &gt; 0">This assignedEntity SHALL contain at least one [1..*] US Realm Address (AD.US.FIELDED) (identifier: urn:oid:2.16.840.1.113883.10.20.22.5.2) (CONF:1198-5616).</sch:assert>
            <sch:assert id="a-1198-5622" test="count(cda:telecom) &gt; 0">This assignedEntity SHALL contain at least one [1..*] telecom (CONF:1198-5622).</sch:assert>
            <sch:assert id="a-1198-5624" test="count(cda:assignedPerson)=1">This assignedEntity SHALL contain exactly one [1..1] assignedPerson (CONF:1198-5624).</sch:assert>
        </sch:rule>
        <sch:rule id="US_Realm-authenticator-assignedEntity-assignedPerson-errors" context="cda:ClinicalDocument/cda:authenticator/cda:assignedEntity/cda:assignedPerson">
            <sch:assert id="a-1198-5625" test="count(cda:name) &gt; 0">This assignedPerson SHALL contain at least one [1..*] US Realm Person Name (PN.US.FIELDED) (identifier: urn:oid:2.16.840.1.113883.10.20.22.5.1.1) (CONF:1198-5625).</sch:assert>
        </sch:rule>
        <sch:rule id="US_Realm-participant-errors" context="cda:ClinicalDocument/cda:participant">
            <sch:assert id="a-1198-10006" test="count(cda:associatedEntity[cda:associatedPerson | cda:scopingOrganization]) &gt; 0">SHALL contain associatedEntity/associatedPerson AND/OR associatedEntity/scopingOrganization (CONF:1198-10006).</sch:assert>
        </sch:rule>
        <sch:rule id="US_Realm-inFulfillmentOf-errors" context="cda:ClinicalDocument/cda:inFulfillmentOf">
        ...
        <sch:rule id="US_Realm-inFulfillmentOf-order-errors" context="cda:ClinicalDocument/cda:inFulfillmentOf/cda:order">
            <sch:assert id="a-1198-9954" test="count(cda:id) &gt; 0">This order SHALL contain at least one [1..*] id (CONF:1198-9954).</sch:assert>
        </sch:rule>
        <sch:rule id="US_Realm-documentationOf-errors" context="cda:ClinicalDocument/cda:documentationOf">
        ...
        <sch:rule id="US_Realm-documentationOf-serviceEvent-errors" context="cda:ClinicalDocument/cda:documentationOf/cda:serviceEvent">
        ...
        <sch:rule id="US_Realm-documentationOf-serviceEvent-effectiveTime-errors" context="cda:ClinicalDocument/cda:documentationOf/cda:serviceEvent/cda:effectiveTime">
        ...
        <sch:rule id="US_Realm-documentationOf-serviceEvent-performer-errors" context="cda:ClinicalDocument/cda:documentationOf/cda:serviceEvent/cda:performer">
        ...
        <sch:rule id="US_Realm-documentationOf-serviceEvent-performer-assignedEntity-errors" context="cda:ClinicalDocument/cda:documentationOf/cda:serviceEvent/cda:performer/cda:assignedEntity">
        ...
        <sch:rule id="US_Realm-authorization-errors" context="cda:ClinicalDocument/cda:authorization">
            <sch:assert id="a-1198-16793" test="count(cda:consent)=1">SHALL contain exactly one [1..1] consent (CONF:1198-16793).</sch:assert>
        </sch:rule>
        <sch:rule id="US_Realm-authorization-consent-errors" context="cda:ClinicalDocument/cda:authorization/cda:consent">
        ...
        <sch:rule id="US_Realm-authorization-consent-statusCode-errors" context="cda:ClinicalDocument/cda:authorization/cda:consent/cda:statusCode">
        ...
        <sch:rule id="US_Realm-componentOf-errors" context="cda:ClinicalDocument/cda:componentOf">
        ...
        <sch:rule id="US_Realm-componentOf-encompassingEncounter-errors" context="cda:ClinicalDocument/cda:componentOf/cda:encompassingEncounter">
    ...
    <sch:pattern id="US_Realm-pattern-warnings">
        <sch:rule id="US_Realm-warnings" context="cda:ClinicalDocument">
        ...
        <sch:rule id="US_Realm-confidentialityCode-warnings" context="cda:ClinicalDocument/cda:confidentialityCode">
        ...
        <sch:rule id="US_Realm-recordTarget-patientRole-telecom-warnings" context="cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:telecom">
        ...
        <sch:rule id="US_Realm-recordTarget-patientRole-patient-warnings" context="cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient">
        ...
        <sch:rule id="US_Realm-recordTarget-patientRole-patient-birthTime-warnings" context="cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient/cda:birthTime">
            <sch:assert id="a-1198-5300" test="string-length(@value) &gt;= 8">SHOULD be precise to day (CONF:1198-5300).</sch:assert>
        </sch:rule>
        <sch:rule id="US_Realm-recordTarget-patientRole-patient-guardian-warnings" context="cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient/cda:guardian">
        ...
        <sch:rule id="US_Realm-recordTarget-patientRole-patient-guardian-telecom-warnings" context="cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient/cda:guardian/cda:telecom">
        ...
        <sch:rule id="US_Realm-recordTarget-patientRole-patient-birthplace-place-addr-warnings" context="cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient/cda:birthplace/cda:place/cda:addr">
        ...
        <sch:rule id="US_Realm-recordTarget-patientRole-patient-languageCommunication-warnings" context="cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:patient/cda:languageCommunication">
        ...
        <sch:rule id="US_Realm-recordTarget-patientRole-providerOrganization-id-warnings" context="cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:providerOrganization/cda:id">
        ...
        <sch:rule id="US_Realm-recordTarget-patientRole-providerOrganization-telecom-warnings" context="cda:ClinicalDocument/cda:recordTarget/cda:patientRole/cda:providerOrganization/cda:telecom">
        ...
        <sch:rule id="US_Realm-author-assignedAuthor-warnings" context="cda:ClinicalDocument/cda:author/cda:assignedAuthor">
        ...
        <sch:rule id="US_Realm-author-assignedAuthor-assignedPerson-warnings" context="cda:ClinicalDocument/cda:author/cda:assignedAuthor/cda:assignedPerson">
        ...
        <sch:rule id="US_Realm-author-assignedAuthor-telecom-warnings" context="cda:ClinicalDocument/cda:author/cda:assignedAuthor/cda:telecom">
        ...
        <sch:rule id="US_Realm-dataEnterer-assignedEntity-id-warnings" context="cda:ClinicalDocument/cda:dataEnterer/cda:assignedEntity/cda:id">
        ...
        <sch:rule id="US_Realm-dataEnterer-assignedEntity-telecom-warnings" context="cda:ClinicalDocument/cda:dataEnterer/cda:assignedEntity/cda:telecom">
        ...
        <sch:rule id="US_Realm-custodian-assignedCustodian-representedCustodianOrganization-id-warnings" context="cda:ClinicalDocument/cda:custodian/cda:assignedCustodian/cda:representedCustodianOrganization/cda:id">
        ...
        <sch:rule id="US_Realm-custodian-assignedCustodian-representedCustodianOrganization-telecom-warnings" context="cda:ClinicalDocument/cda:custodian/cda:assignedCustodian/cda:representedCustodianOrganization/cda:telecom">
        ...
        <sch:rule id="US_Realm-legalAuthenticator-assignedEntity-telecom-warnings" context="cda:ClinicalDocument/cda:legalAuthenticator/cda:assignedEntity/cda:telecom">
        ...
        <sch:rule id="US_Realm-authenticator-assignedEntity-telecom-warnings" context="cda:ClinicalDocument/cda:authenticator/cda:assignedEntity/cda:telecom">
        ...
        <sch:rule id="US_Realm-participant-typeCode-warnings" context="cda:ClinicalDocument/cda:participant[@typeCode='IND']">
        ...
        <sch:rule id="US_Realm-documentationOf-serviceEvent-warnings" context="cda:ClinicalDocument/cda:documentationOf/cda:serviceEvent">
        ...
        <sch:rule id="US_Realm-documentationOf-serviceEvent-performer-functionCode-warnings" context="cda:ClinicalDocument/cda:documentationOf/cda:serviceEvent/cda:performer/cda:functionCode">
        ...
        <sch:rule id="US_Realm-documentationOf-serviceEvent-performer-assignedEntity-warnings" context="cda:ClinicalDocument/cda:documentationOf/cda:serviceEvent/cda:performer/cda:assignedEntity">
        ...
        <sch:rule id="US_Realm-documentationOf-serviceEvent-performer-assignedEntity-id-warnings" context="cda:ClinicalDocument/cda:documentationOf/cda:serviceEvent/cda:performer/cda:assignedEntity/cda:id">
