...
<sch:schema xmlns:voc="http://www.lantanagroup.com/voc" xmlns:svs="urn:ihe:iti:svs:2008" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:sdtc="urn:hl7-org:sdtc" xmlns="urn:hl7-org:v3" xmlns:cda="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
    ...
    <sch:pattern id="Ethnicity_supp_data_element_CMS-pattern-errors">
        <sch:rule id="Ethnicity_supp_data_element_CMS-errors" context="cda:observation[cda:templateId[@root='2.16.840.1.113883.10.20.27.3.22']]">
            ...
            <sch:assert id="a-1109-711253-error" test="count(cda:templateId[@root='2.16.840.1.113883.10.20.27.3.22'][not(@extension)])=1">SHALL contain exactly one [1..1] templateId (CONF:1109-711253) such that it SHALL contain exactly one [1..1] @root="2.16.840.1.113883.10.20.27.3.22" (CONF:1109-711254).</sch:assert>
