...
<sch:schema xmlns:svs="urn:ihe:iti:svs:2008" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:sdtc="urn:hl7-org:sdtc" xmlns="urn:hl7-org:v3" xmlns:cda="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
	...
	<sch:pattern id="QRDA_Category_III_Payer_Supplemental_Data_Element_CMS_EP_V2-pattern-errors">
		<sch:rule id="QRDA_Category_III_Payer_Supplemental_Data_Element_CMS_EP_V2-errors" context="cda:observation[cda:templateId[@root='2.16.840.1.113883.10.20.27.3.18']]">
			<sch:assert id="a-2233-21155-error" test="@classCode='OBS'"> 
				SHALL contain exactly one [1..1] @classCode="OBS" (CodeSystem: HL7ActClass urn:oid:2.16.840.1.113883.5.6 STATIC) (CONF:2233-21155).
			</sch:assert>
			<sch:assert id="a-2233-21156-error" test="@moodCode='EVN'"> 
				SHALL contain exactly one [1..1] @moodCode="EVN" (CodeSystem: ActMood urn:oid:2.16.840.1.113883.5.1001 STATIC) (CONF:2233-21156).			
			</sch:assert>
			...
			<sch:assert id="a-2233-21158-error" test="count(cda:code) = 1"> 
				SHALL contain exactly one [1..1] code (CONF:2233-21158).
			</sch:assert>
			<sch:assert id="a-2233-18106-error" test="count(cda:statusCode) = 1"> 
				SHALL contain exactly one [1..1] statusCode (CONF:2233-18106).
			</sch:assert>
			...
			<sch:assert id="a-2233-18108-error" test="count(cda:entryRelationship[@typeCode='SUBJ'][@inversionInd='true'][cda:observation[cda:templateId[@root='2.16.840.1.113883.10.20.27.3.24']]]) = 1"> 
				SHALL contain exactly one [1..1] entryRelationship (CONF:2233-18108) such that it
		...
		<sch:rule id="QRDA_Category_III_Payer_Supplemental_Data_Element_CMS_EP_V2-code-errors" context="cda:observation[cda:templateId[@root = '2.16.840.1.113883.10.20.27.3.18']]/cda:code">
			<sch:assert id="a-2233-21159-error" test="@code='48768-6'"> 
				This code SHALL contain exactly one [1..1] @code="48768-6" Payment source  (CONF:2233-21159).
			</sch:assert>
			<sch:assert id="a-2233-21165-error" test="@codeSystem='2.16.840.1.113883.6.1'"> 
				This code SHALL contain exactly one [1..1] @codeSystem="2.16.840.1.113883.6.1" (CodeSystem: LOINC urn:oid:2.16.840.1.113883.6.1) (CONF:2233-21165).
			</sch:assert>
		</sch:rule>
		...
		<sch:rule id="QRDA_Category_III_Payer_Supplemental_Data_Element_CMS_EP_V2-statusCode-errors" context="cda:observation[cda:templateId[@root = '2.16.840.1.113883.10.20.27.3.18']]/cda:statusCode">
			<sch:assert id="a-2233-18107-error" test="@code='completed'"> 
				This statusCode SHALL contain exactly one [1..1] @code="completed" Completed (CodeSystem: ActStatus urn:oid:2.16.840.1.113883.5.14 STATIC) (CONF:2233-18107).
			</sch:assert>
		</sch:rule>
