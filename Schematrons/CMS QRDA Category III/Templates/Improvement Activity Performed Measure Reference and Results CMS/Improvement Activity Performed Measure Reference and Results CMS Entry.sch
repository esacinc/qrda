...
<sch:schema xmlns:svs="urn:ihe:iti:svs:2008" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:sdtc="urn:hl7-org:sdtc" xmlns="urn:hl7-org:v3" xmlns:cda="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
	...
	<!-- CMS_74 Changed from SHALL to MAY in IG for 2019
	...
	<sch:pattern id="Improvement_Activity_Performed_Measure_Reference_and_Results_CMS-pattern-errors">
		<sch:rule id="Improvement_Activity_Performed_Measure_Reference_and_Results_CMS-component-errors" context="cda:organizer[cda:templateId[@root='2.16.840.1.113883.3.249.20.3.1'][@extension='2018-05-01']]" >
