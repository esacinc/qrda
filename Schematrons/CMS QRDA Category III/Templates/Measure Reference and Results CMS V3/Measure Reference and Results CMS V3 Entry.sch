...
<sch:schema xmlns:svs="urn:ihe:iti:svs:2008" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:sdtc="urn:hl7-org:sdtc" xmlns="urn:hl7-org:v3" xmlns:cda="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron">
	...
	<sch:phase id="warnings">
		<sch:active pattern="Measure_Reference_and_Results_CMS-pattern-warnings"/>
	</sch:phase>
	
	<sch:pattern id="Measure_Reference_and_Results_CMS-pattern-errors">
		<sch:rule id="Measure_Reference_and_Results_CMS-errors" context="cda:organizer[cda:templateId[@root='2.16.840.1.113883.10.20.27.3.17']]">
		...
		<sch:rule id="Measure_Reference_and_Results_CMS-statusCode-errors" context="cda:organizer[cda:templateId[@root='2.16.840.1.113883.10.20.27.3.17']]/cda:statusCode">
		...
		<sch:rule id="Measure_Reference_and_Results_CMS-externalDocument-errors" context="cda:organizer[cda:templateId[@root='2.16.840.1.113883.10.20.27.3.17']]/cda:reference/cda:externalDocument">
		...
		<sch:rule id="Measure_Reference_and_Results_CMS-externalDocument-code-errors" context="cda:organizer[cda:templateId[@root='2.16.840.1.113883.10.20.27.3.17']]/cda:reference/cda:externalDocument/cda:code">
	...
	<sch:pattern id="Measure_Reference_and_Results_CMS-pattern-warnings">
		<sch:rule id="Measure_Reference_and_Results_CMS-externalDocument-warnings" context="cda:organizer[cda:templateId[@root='2.16.840.1.113883.10.20.27.3.17']]/cda:reference/cda:externalDocument">
